...
SimpleNavigation::Configuration.run do |navigation|
  navigation.items do |side_nav|
    if @organization.try(:persisted?)
      side_nav.item :timetables,  '<span></span><b>Расписания</b>', workplace_timetables_path,    :highlights_on => -> { ['timetables', 'weeks'].include?(controller_name) }
      ...
      side_nav.item :buildings,   '<span></span><b>Корпуса и аудитории</b>',    workplace_buildings_path,     :highlights_on => -> { controller_name == 'buildings' }
